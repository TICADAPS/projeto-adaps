...
# instanciando um objeto da classe Avaliacoes
$modelAvaliacao = new Source\Models\Avaliacoes();
$aval = $modelAvaliacao->find("idMedico=:id", "id={$idMedico}");
if($aval != null){
   $dataAvaliacao = $aval->data_registro; 
   //var_dump($aval);
}
...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $crudProcedure->CallProcedure($idMed, $opc1, $opc2, $opc3);
    header("Location:index.php");
    //var_dump($idMed, $opc1, $opc2, $opc3);
}
