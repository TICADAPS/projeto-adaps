...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-8 col-sm-6 mt-5 ">
            ...
            <p>Você deve escolher 3 opções de municípios para se candidatar a uma vaga</p>
            ...
            if(!isset($idVagaMedico)): ?>
                <div class="col-md-6">
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <label for="estado"><b>Escolha o Estado:</b></label>
                            </div>
                            <select class="col-md-7 form-control mb-4" name="estado" id="estado">
                                <?php
                                    foreach ($uf as $value):                                    
                                    ?>
                                    <option value="<?= $value->cod_uf; ?>"><?= $value->UF; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="row">
